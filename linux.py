...
ip_addr = os.popen("ip addr | grep \"inet \" | grep -Fv 127.0.0.1 | awk \'{print $2}\'").read().strip()
...
# replace Bxxxxxxxx and YOUR_PASSWORD as your actual Student ID and password in next line.
# replace njxy to cmcc if you use the Chine Mobile and delete it if you use school provided network. (experimental)
